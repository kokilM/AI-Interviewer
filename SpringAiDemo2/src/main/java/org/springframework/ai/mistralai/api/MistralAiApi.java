...
public class MistralAiApi {
    ...
    public ResponseEntity<ChatCompletion> chatCompletionEntity(ChatCompletionRequest chatRequest) {
        ...
        ResponseEntity<ChatCompletion> chatentity = null;
        try{
             chatentity = this.restClient.post()
           ...
           Exception e
            ...
            System.out.println("error -> "+ e.getMessage() + " | " + chatentity);
        }
        return chatentity;
    }
    ...
    public record ChatCompletionRequest(
        ...
        public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model) {
            this(model, messages, null, null, 0.7, 1.0, null, false, null, null, null);
        }
        ...
        public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, Double temperature,
                                     boolean stream) {
            this(model, messages, null, null, temperature, 1.0, null, stream, null, null, null);
        }
         ...
         */
        public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, Double temperature) {
            this(model, messages, null, null, temperature, 1.0, null, false, null, null, null);
        }
        ...
        public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, List<FunctionTool> tools,
            ...
            this(model, messages, tools, toolChoice, null, 1.0, null, false, null, null, null);
        }
        ...
        public ChatCompletionRequest(List<ChatCompletionMessage> messages, Boolean stream) {
            this(null, messages, null, null, 0.7, 1.0, null, stream, null, null, null);
        }
